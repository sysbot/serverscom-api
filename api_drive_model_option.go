...
// DriveModelOptionApiService DriveModelOptionApi service
type DriveModelOptionApiService service

// ListAllDriveModelsOptionsForServerModelOpts Optional parameters for the method 'ListAllDriveModelsOptionsForServerModel'
type ListAllDriveModelsOptionsForServerModelOpts struct {
...
/*
ListAllDriveModelsOptionsForServerModel List all drive models options for server model
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param locationId
 * @param serverModelId
 * @param optional nil or *ListAllDriveModelsOptionsForServerModelOpts - Optional Parameters:
 * @param "SearchPattern" (optional.String) -   search pattern
 * @param "MediaType" (optional.String) -   media type
 * @param "Interface_" (optional.String) -   interface
...
@return []V1OrderOptionsDriveModelsBase
*/
func (a *DriveModelOptionApiService) ListAllDriveModelsOptionsForServerModel(ctx _context.Context, locationId string, serverModelId string, localVarOptionals *ListAllDriveModelsOptionsForServerModelOpts) ([]V1OrderOptionsDriveModelsBase, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  []V1OrderOptionsDriveModelsBase
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/locations/{location_id}/order_options/server_models/{server_model_id}/drive_models"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v []V1OrderOptionsDriveModelsBase
...
/*
RetrieveAnExistingDriveModelOption Retrieve an existing drive model option
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param locationId
 * @param serverModelId
 * @param driveModelId
@return V1OrderOptionsDriveModelsBase
*/
func (a *DriveModelOptionApiService) RetrieveAnExistingDriveModelOption(ctx _context.Context, locationId string, serverModelId string, driveModelId string) (V1OrderOptionsDriveModelsBase, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/locations/{location_id}/order_options/server_models/{server_model_id}/drive_models/{drive_model_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"location_id"+"}", _neturl.QueryEscape(parameterToString(locationId, "")), -1)

	localVarPath = strings.Replace(localVarPath, "{"+"server_model_id"+"}", _neturl.QueryEscape(parameterToString(serverModelId, "")), -1)

	localVarPath = strings.Replace(localVarPath, "{"+"drive_model_id"+"}", _neturl.QueryEscape(parameterToString(driveModelId, "")), -1)
