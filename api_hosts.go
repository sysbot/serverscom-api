...
// ListAllHostsOpts Optional parameters for the method 'ListAllHosts'
type ListAllHostsOpts struct {
...
/*
ListAllHosts List all hosts
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ListAllHostsOpts - Optional Parameters:
...
@return []TheDedicatedServerEntitySchema
*/
func (a *HostsApiService) ListAllHosts(ctx _context.Context, localVarOptionals *ListAllHostsOpts) ([]TheDedicatedServerEntitySchema, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  []TheDedicatedServerEntitySchema
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v []TheDedicatedServerEntitySchema
