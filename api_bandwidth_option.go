...
// BandwidthOptionApiService BandwidthOptionApi service
type BandwidthOptionApiService service

// ListAllBandwidthForUplinkOpts Optional parameters for the method 'ListAllBandwidthForUplink'
type ListAllBandwidthForUplinkOpts struct {
...
/*
ListAllBandwidthForUplink List all bandwidth for uplink
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param locationId
 * @param serverModelId
 * @param uplinkModelId
 * @param optional nil or *ListAllBandwidthForUplinkOpts - Optional Parameters:
...
@return []V1OrderOptionsBandwidthBase
*/
func (a *BandwidthOptionApiService) ListAllBandwidthForUplink(ctx _context.Context, locationId string, serverModelId string, uplinkModelId string, localVarOptionals *ListAllBandwidthForUplinkOpts) ([]V1OrderOptionsBandwidthBase, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  []V1OrderOptionsBandwidthBase
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/locations/{location_id}/order_options/server_models/{server_model_id}/uplink_models/{uplink_model_id}/bandwidth"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v []V1OrderOptionsBandwidthBase
...
/*
RetrieveAnExistingBandwidth Retrieve an existing bandwidth
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param locationId
 * @param serverModelId
 * @param uplinkModelId
...
@return V1OrderOptionsBandwidthBase
*/
func (a *BandwidthOptionApiService) RetrieveAnExistingBandwidth(ctx _context.Context, locationId string, serverModelId string, uplinkModelId string, bandwidthId string) (V1OrderOptionsBandwidthBase, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/locations/{location_id}/order_options/server_models/{server_model_id}/uplink_models/{uplink_model_id}/bandwidth/{bandwidth_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"location_id"+"}", _neturl.QueryEscape(parameterToString(locationId, "")), -1)
	...
	localVarPath = strings.Replace(localVarPath, "{"+"bandwidth_id"+"}", _neturl.QueryEscape(parameterToString(bandwidthId, "")), -1)
