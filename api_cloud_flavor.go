...
// CloudFlavorApiService CloudFlavorApi service
type CloudFlavorApiService service

// ListCloudFlavorsOpts Optional parameters for the method 'ListCloudFlavors'
type ListCloudFlavorsOpts struct {
	PerPage optional.Int32
	Page    optional.Int32
}

/*
ListCloudFlavors List cloud flavors
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param regionId
 * @param optional nil or *ListCloudFlavorsOpts - Optional Parameters:
 * @param "PerPage" (optional.Int32) -   per page
 * @param "Page" (optional.Int32) -   page
@return []TheItemsSchema1
*/
func (a *CloudFlavorApiService) ListCloudFlavors(ctx _context.Context, regionId string, localVarOptionals *ListCloudFlavorsOpts) ([]TheItemsSchema1, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/cloud_computing/regions/{region_id}/flavors"
