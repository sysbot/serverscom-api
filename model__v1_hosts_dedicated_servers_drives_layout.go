...
// V1HostsDedicatedServersDrivesLayout struct for V1HostsDedicatedServersDrivesLayout
type V1HostsDedicatedServersDrivesLayout struct {
	SlotPositions []int32                                   `json:"slot_positions"`
	Raid          *int32                                    `json:"raid,omitempty"`
	Ignore        *bool                                     `json:"ignore,omitempty"`
	Partitions    []V1HostsDedicatedServersDrivesPartitions `json:"partitions,omitempty"`
}
