...
// CloudRegionApiService CloudRegionApi service
type CloudRegionApiService service

// ListCloudRegionsOpts Optional parameters for the method 'ListCloudRegions'
type ListCloudRegionsOpts struct {
	PerPage optional.Int32
	Page    optional.Int32
}

/*
ListCloudRegions List cloud regions
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ListCloudRegionsOpts - Optional Parameters:
 * @param "PerPage" (optional.Int32) -   per page
 * @param "Page" (optional.Int32) -   page
@return []TheItemsSchema4
*/
func (a *CloudRegionApiService) ListCloudRegions(ctx _context.Context, localVarOptionals *ListCloudRegionsOpts) ([]TheItemsSchema4, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/cloud_computing/regions"
